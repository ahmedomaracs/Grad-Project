...
export function Testimonials() {
  return (
    <section id="testimonials" className="py-32 bg-[#111111] relative overflow-hidden">
      {/* Background Glow */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full max-w-4xl h-full bg-[#FF2D2D]/5 blur-[120px] pointer-events-none" />
          ...
          {testimonials.map((testimonial, index) => (
            ...
            >
              ...
              <div className="flex gap-1 mb-8">
                {[...Array(5)].map((_, i) => (
                  <svg key={i} className="w-5 h-5 text-[#FF2D2D] drop-shadow-[0_0_8px_rgba(255,45,45,0.8)]" fill="currentColor" viewBox="0 0 20 20">
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                  ...
                  <div className="text-sm text-[#FF2D2D] font-medium">{testimonial.role}</div>
                </div>
              </div>
            </motion.div>
          ))}
