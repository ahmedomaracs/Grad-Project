...
export const metadata: Metadata = {
  ...
  description: 'Automate Terms of Service. Review rules, agreements, and mechanical compliance bonds before dispatching mechanics.',
};
      ...
      <main id="main-content" className="flex-grow pt-32 pb-24 px-6 lg:px-16 max-w-7xl mx-auto w-full relative z-10">
        ...
        <div className="space-y-16">
          ...
          <div className="prose prose-invert max-w-none space-y-6">
            ...
            <div className="pt-6">
              <Link href="/privacy" className="inline-flex items-center gap-2 text-[#E12F2F] text-sm font-bold uppercase tracking-widest cursor-pointer hover:underline">
